...
class ArchiveExhibition extends BaseModel {
    ...
    public function strings() : array {
        return [
            'search'           => [
                'label'             => __( 'Search from archive', 'tms-theme-savel' ),
                'submit_value'      => __( 'Search', 'tms-theme-savel' ),
                'input_placeholder' => __( 'Type a search word', 'tms-theme-savel' ),
            ],
            'no_results'       => __( 'No results', 'tms-theme-savel' ),
            'year_label'       => __( 'Year', 'tms-theme-savel' ),
            'year_filter_info' => __( 'Selecting the year filter limits the exhibition view.', 'tms-theme-savel' ),
            'upcoming_badge'   => __( 'Upcoming', 'tms-theme-savel' ),
        ];
    }
    ...
    public function tabs() : array {
        ...
        return [
            'upcoming' => [
                'text'      => __( 'Upcoming exhibitions', 'tms-theme-savel' ),
                'link'      => add_query_arg(
            ...
            'ongoing' => [
                'text'      => __( 'Current exhibitions', 'tms-theme-savel' ),
                'link'      => $base_url,
                'is_active' => ! $past_tab_active && ! $upcoming_tab_active,
            ],
            'past'     => [
                'text'      => __( 'Past exhibitions', 'tms-theme-savel' ),
                'link'      => add_query_arg(
                    self::PAST_QUERY_VAR,
                    '',
                    $base_url
    ...
    public function years() {
        ...
        $choices[] = [
            ...
            'label'       => __( 'Filter by year', 'tms-theme-savel' ),
        ];
