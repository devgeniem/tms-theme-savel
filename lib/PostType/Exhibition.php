...
class Exhibition implements PostType {
    ...
    public function __construct() {
        $this->description = _x( 'Exhibition', 'theme CPT', 'tms-theme-savel' );
    }
    ...
    private function register() {
        $labels = [
            'name'                  => _x( 'Exhibition', 'theme CPT', 'tms-theme-savel' ),
    ...
    private function get_breadcrumbs_base( $is_cpt_archive = false ) : array {
        return [
            ...
            [
                'title'     => _x( 'Exhibition', 'Breadcrumb text', 'tms-theme-savel' ),
