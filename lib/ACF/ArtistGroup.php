...
class ArtistGroup {
            ...
            $field_group->add_fields(
                \apply_filters(
                    ...
                    [
                        ...
                        $this->get_festival_tab( $field_group->get_key() ),
                    ]
                )
            );
    ...
    protected function get_festival_tab( string $key ) : Field\Tab {
        ...
        $festival_field = ( new Field\PostObject( $strings['festival']['title'] ) )
            ->set_key( "{$key}_festivals" )
            ->set_name( 'festivals' )
            ->set_post_types( [ PostType\Festival::SLUG ] )
            ->allow_multiple()
            ->set_default_value( null )
            ->allow_null()
            ->set_instructions( $strings['festival']['instructions'] );
